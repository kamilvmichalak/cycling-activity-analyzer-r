...
- [ ] Aplikacja uruchamia się przez `shiny::runApp()`.
- [ ] Pliki z katalogu `R/` można wczytać przez `source()` bez błędów.
- [ ] Prywatne pliki `.fit` nie są śledzone przez Git.
- [ ] Brak pakietu importującego FIT powoduje czytelny komunikat.
